# Guide du catalogue — pour la gérante

> Mode d'emploi de la page d'administration du site La Géode.
> À imprimer ou garder sous la main. Aucune connaissance technique nécessaire.
...
- **« Mot de passe incorrect »** : vérifier les majuscules/minuscules
- **La page ne réagit plus** : recharger (F5) — les modifications non
  publiées sont perdues, mais tout ce qui a été publié est intact
- **Une erreur publiée** (mauvais prix, faute…) : pas de panique, on modifie
  l'article et on republie ; rien n'est jamais définitif
- Autre souci : appeler Thomas 🙂
